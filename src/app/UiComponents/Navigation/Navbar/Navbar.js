...
import {Box, Drawer, Hidden, IconButton, List, ListItem, ListItemIcon, ListItemText, Typography,} from "@mui/material";
          ...
          <Box>
              ...
              <List>
                  {filteredNavItems.map((item) => (
                        <Link href={item.href} passHref key={item.href} onClick={() => handleMobileDrawerToggle()}>
                            <ListItem
                                  button
                                  sx={{
